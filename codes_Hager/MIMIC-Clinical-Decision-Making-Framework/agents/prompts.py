...
ECG_TOOL_DESCR = "\nECG: Retrieve the earliest available ECG report. Only use when cardiac symptoms or signs are present."
...
DIAGNOSTIC_CRITERIA_CHOLANGITIS = """To diagnose cholangitis consider the following criteria: General symptoms usually include Charcot's triad — fever with chills, jaundice, and right upper quadrant (RUQ) abdominal pain. In severe cases, Reynolds' pentad adds altered mental status and hypotension. During a physical examination, a patient might display RUQ tenderness, jaundice, and fever. Laboratory tests may reveal signs of inflammation, such as elevated white blood cell count and C-reactive protein levels, biliary obstruction indicated through elevated bilirubin, alkaline phosphatase (ALP), and gamma-glutamyltransferase (GGT) levels, and liver damage indicated through elevated ALT and AST levels. Imaging, preferably ultrasound, may show common bile duct dilation, choledocholithiasis, or biliary obstruction. ERCP is both diagnostic and therapeutic."""

DIAGNOSTIC_CRITERIA_BOWEL_OBSTRUCTION = """To diagnose bowel obstruction consider the following criteria: General symptoms usually include colicky abdominal pain, abdominal distension, nausea or vomiting, and obstipation (inability to pass gas or stool). During a physical examination, a patient might display abdominal distension, high-pitched or absent bowel sounds, and diffuse tenderness. Laboratory tests may reveal signs of dehydration such as electrolyte abnormalities (sodium, potassium, chloride, bicarbonate), elevated BUN and creatinine, and signs of inflammation such as elevated white blood cell count. Imaging, preferably CT of the abdomen, may show dilated bowel loops, air-fluid levels, a transition point, and the cause of obstruction (adhesions, hernia, mass)."""

DIAGNOSTIC_CRITERIA_PYELONEPHRITIS = """To diagnose pyelonephritis consider the following criteria: General symptoms usually include flank pain, fever with chills, and dysuria or urinary frequency. During a physical examination, a patient might display costovertebral angle (CVA) tenderness, fever, and suprapubic tenderness. Laboratory tests should include urinalysis revealing pyuria (elevated urine WBC), positive nitrites, and leukocyte esterase, along with signs of inflammation such as elevated white blood cell count and C-reactive protein levels, and assessment of renal function through creatinine and BUN levels. Imaging, preferably CT of the abdomen, may show perinephric fat stranding, renal enlargement, or complications such as abscess or hydronephrosis."""

DIAGNOSTIC_CRITERIA_MYOCARDIAL_INFARCTION = """To diagnose myocardial infarction consider the following criteria: General symptoms usually include acute chest pain or pressure, often substernal, radiating to the left arm, jaw, or back, accompanied by diaphoresis, dyspnea, nausea, or lightheadedness. During a physical examination, a patient might display tachycardia, hypotension, diaphoresis, S3 or S4 heart sounds, or signs of heart failure. Laboratory tests should include serial high-sensitivity troponin measurements (elevated troponin T or I is the hallmark) and inflammatory markers. ECG may show ST-segment elevation (STEMI), ST depression, T-wave inversions, or new Q waves. Echocardiogram may reveal regional wall motion abnormalities. Treatment typically includes dual antiplatelet therapy, anticoagulation, and consideration of percutaneous coronary intervention (PCI) or coronary artery bypass grafting (CABG)."""

DIAGNOSTIC_CRITERIA_PULMONARY_EMBOLISM = """To diagnose pulmonary embolism consider the following criteria: General symptoms usually include acute dyspnea, pleuritic chest pain, cough, and occasionally hemoptysis. Risk factors include recent immobilization, surgery, malignancy, or history of deep vein thrombosis. During a physical examination, a patient might display tachycardia, tachypnea, hypoxemia, unilateral leg swelling (suggesting DVT), or signs of right heart strain. Laboratory tests should include D-dimer (elevated, highly sensitive but not specific) and troponin (prognostic marker for right ventricular dysfunction). CT pulmonary angiography (CTPA) is the gold standard imaging, showing intraluminal filling defects. Chest radiograph may show Hampton's hump or Westermark sign but is often normal. Treatment includes immediate anticoagulation with heparin followed by oral anticoagulants, with consideration of thrombolysis or thrombectomy in massive PE."""

DIAGNOSTIC_CRITERIA_CONGESTIVE_HEART_FAILURE = """To diagnose congestive heart failure consider the following criteria: General symptoms usually include dyspnea (exertional and orthopnea), paroxysmal nocturnal dyspnea, fatigue, and peripheral edema. During a physical examination, a patient might display jugular venous distension, S3 gallop, bilateral pulmonary crackles or rales, hepatomegaly, and bilateral lower extremity edema. Laboratory tests should include BNP or NT-proBNP (markedly elevated), assessment of renal function (creatinine, BUN), and electrolytes. Chest radiograph typically shows cardiomegaly, pulmonary vascular congestion, pleural effusions, or Kerley B lines. Echocardiogram is the definitive test, assessing ejection fraction, wall motion, and valvular function. Treatment includes diuretics for volume overload, ACE inhibitors or ARBs, beta-blockers, and salt/fluid restriction."""

DIAGNOSTIC_CRITERIA_AORTIC_STENOSIS = """To diagnose aortic stenosis consider the following criteria: General symptoms usually include the classic triad of exertional dyspnea, angina, and syncope. Many patients are asymptomatic until disease is severe. During a physical examination, a patient might display a harsh crescendo-decrescendo systolic murmur best heard at the right upper sternal border radiating to the carotids, pulsus parvus et tardus (weak and delayed carotid upstroke), and a narrowed pulse pressure. Laboratory tests should include BNP or NT-proBNP (elevated in symptomatic disease). Echocardiogram is the definitive diagnostic test, showing aortic valve calcification, reduced valve area (<1.0 cm² indicates severe), elevated mean gradient (>40 mmHg), and peak velocity (>4 m/s). Treatment for symptomatic severe aortic stenosis is valve replacement (surgical or transcatheter TAVR)."""

DIAGNOSTIC_CRITERIA_MITRAL_REGURGITATION = """To diagnose mitral regurgitation consider the following criteria: General symptoms usually include dyspnea, fatigue, palpitations, and in chronic cases, symptoms of heart failure. Acute mitral regurgitation may present with sudden pulmonary edema and hemodynamic instability. During a physical examination, a patient might display a holosystolic murmur at the apex radiating to the axilla, a laterally displaced PMI, and an S3 if volume overloaded. Laboratory tests should include BNP or NT-proBNP (elevated in symptomatic disease with volume overload). Echocardiogram is the definitive diagnostic test, showing the regurgitant jet, its mechanism (prolapse, flail leaflet, functional), severity grading (effective regurgitant orifice, regurgitant volume), and left ventricular size and function. Treatment includes diuretics and vasodilators for symptom management, with mitral valve repair or replacement indicated for severe symptomatic disease or progressive LV dysfunction."""
