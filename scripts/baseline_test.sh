...
for P in "${PATHOLOGIES[@]}"; do
    ...
    ZS_TRAJ="$TRAJ_DIR/zs_baseline${PATSIM_SUFFIX}_${P}_test100.json"
...
for P in "${PATHOLOGIES[@]}"; do
    PATIENT_DATA="$DATA_DIR/$P/test.pkl"
    TOT_TRAJ="$TRAJ_DIR/tot_baseline${PATSIM_SUFFIX}_${P}_test100.json"
...
for P in "${PATHOLOGIES[@]}"; do
    ZS_TRAJ="$TRAJ_DIR/zs_baseline${PATSIM_SUFFIX}_${P}_test100.json"
    TOT_TRAJ="$TRAJ_DIR/tot_baseline${PATSIM_SUFFIX}_${P}_test100.json"
    COMPARISON="$COMP_DIR/baseline_zs_vs_tot${PATSIM_SUFFIX}_${P}_test100.md"
...
for P in "${PATHOLOGIES[@]}"; do
    echo "    ZS:  $TRAJ_DIR/zs_baseline${PATSIM_SUFFIX}_${P}_test100.json"
    echo "    ToT: $TRAJ_DIR/tot_baseline${PATSIM_SUFFIX}_${P}_test100.json"
done
echo ""
echo "  Full comparison reports:"
for P in "${PATHOLOGIES[@]}"; do
    echo "    cat $COMP_DIR/baseline_zs_vs_tot${PATSIM_SUFFIX}_${P}_test100.md"
done
echo ""
echo "  Next steps:"
