...
#   bash scripts/evotest_test.sh --no-patient-sim skills/evo/episode_5.md vLLM_Qwen3 True
#   bash scripts/evotest_test.sh --agent ToT --tot-max-depth 15 skills/evo_tot_patsim/episode_4.md
#
# The script will:
...
BEST_SKILL="${1:?Usage: $0 [--agent ToT] [--no-patient-sim] <BEST_SKILL_PATH> [MODEL] [ANNOTATE_CLINICAL]}"
MODEL="${2:-vLLM_Qwen3}"
